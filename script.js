const quizSet = [
  {
    question: 'Webサーバーが何らかのエラーによってリクエストに応えられない場合や、高負荷状態で一時的にWebコンテンツを転送できない場合にWebサーバーのエラーであることを通＿知するステータスコードは〇〇番',
    answer: '500',
  },
  {
    question: 'クライアント(Webブラウザ)のエラーであることを通知するステータスコードは〇〇番',
    answer: '400',
  },
  {
